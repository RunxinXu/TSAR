...
TRAIN_DGLGRAPH=../data/wikievents/dglgraph-wikievent-train.pkl
DEV_DGLGRAPH=../data/wikievents/dglgraph-wikievent-dev.pkl
TEST_DGLGRAPH=../data/wikievents/dglgraph-wikievent-test.pkl
